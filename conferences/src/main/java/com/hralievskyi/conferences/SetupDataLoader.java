...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		if (alreadySetup)
			return;
		createRoleIfNotFound(Roles.ROLE_CUSTOMER.toString());
		...
		Role custRole = roleRepository.findByName(Roles.ROLE_CUSTOMER.toString());
		User user = new User();
		...
		speakerB.setUsername("speaker_b");
		...
		speakerC.setUsername("speaker_c");
